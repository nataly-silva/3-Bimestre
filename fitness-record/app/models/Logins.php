...
class Logins extends Model {
    ...
    #nao esqueça da ID
    protected $fields = ["id","nome","dataNascimento","tipo","email","senha"];
    
    const COMUM_USER = 1;
    const ADMIN_USER = 5;

    public static $userTypes = [Logins::COMUM_USER=>"Usuário comum", Logins::ADMIN_USER=>"Admin"];
    ...
    public function save($data){
        ...
        $sql = "INSERT INTO logins (".implode(",",$fields).") 
                    VALUES 
                (:".implode(",:",$fields).")";
